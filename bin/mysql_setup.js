...
connection.query('CREATE TABLE IF NOT EXISTS `' + config.database +'`.`pulls` ( `id` INT NOT NULL , `number` INT NOT NULL , `created_at` VARCHAR( 20 ) NOT NULL , `updated_at`  VARCHAR( 20 ) NOT NULL , `head` VARCHAR( 40 ) NOT NULL , `files` TEXT NOT NULL , PRIMARY KEY (  `id` ) ) ENGINE = INNODB;');

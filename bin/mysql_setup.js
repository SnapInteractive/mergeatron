...
connection.query('CREATE TABLE IF NOT EXISTS `' + config.database +'`.`pulls` ( `id` INT NOT NULL , `number` INT NOT NULL , `created_at` INT NOT NULL , `updated_at` INT NOT NULL , `head` VARCHAR( 40 ) NOT NULL , `files` TEXT NOT NULL , PRIMARY KEY (  `id` ) ) ENGINE = INNODB;');
